...
Entities in the [`sensor`](https://www.home-assistant.io/components/sensor) domain | 839
...
Entities in the [`select`](https://www.home-assistant.io/components/select) domain | 10
